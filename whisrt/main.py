...
def main():
    ...
    parser.add_argument("-l", "--language", type=str, help="Specify the language for subtitles. If left unspecified, the language is inferred. This is a two letter (BCP-47) language code (e.g. '--language=ja').")
